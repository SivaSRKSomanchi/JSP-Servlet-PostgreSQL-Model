  ...
  <div class="contentwrapper" id="contact">
    ...
    <div class="character">
      ...
      <div class="thoughts">
        ...
        <div class="abouttype">
          <p>We're from National Hospitals Patient Portal</p>
          <div class="imacontainer"><span class="ima"></span></div>
          <p>We are at multiple locations. You can get our locations from locations tab.
          You can reach us at Ph.No. +1-800-200-300.
          You can email us at national@nh.com . Thank You!</p>
