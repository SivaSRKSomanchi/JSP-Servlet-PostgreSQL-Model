	...
	<div class="container">
		<div class="row text-center">
			<div class="col-sm-6 col-sm-offset-3">
				<br>
				<br>
				<h1 style="color: #0fad00">Payment Successful</h1>
				<img src="https://www.orefauji.com/img/success.jpg">
				<h2>Dear, User</h2>
				<h4><p style="font-size: 20px; color: #5C5C5C;">Your payment process went safely and securely. </p></h4>
				<h3><input type="submit" value="Back To Home" class="btn btn-success"></h3> <br>
				<br>
			</div>
		</div>
	</div>
